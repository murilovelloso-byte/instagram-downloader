...
<footer style="margin-left:-240px;width:100vw;background:#0f172a;margin-top:48px;padding:22px 0 26px;text-align:center;color:rgba(255,255,255,.35);font-size:12px;border-top:1px solid rgba(255,255,255,.07)">
